...
{
    internal class SecurityEditUserVM : AgentViewModel
    {
        ...
        {
            PageTitle = "Photon Agent Edit User Security";
        }
        ...
        protected override void OnBuild()
        {
            ...
            if (!string.IsNullOrEmpty(UserId)) {
                if (!PhotonAgent.Instance.UserMgr.TryGetUserById(UserId, out var _user))
